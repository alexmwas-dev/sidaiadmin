...
import { Time, IAnimation, AnimationState } from "./Animation";
...
export declare abstract class Settings implements IDisposer, IAnimation, IStartAnimation {
    ...
    _runAnimation(currentTime: number): AnimationState;
     ...
     * @since 5.9.2
     */
    off<Key extends keyof this["_settings"]>(key: Key, callback?: (value: this["_settings"][Key], target?: this, key?: Key) => void): void;
    /**
     ...
     * @since 5.9.2
     */
    offPrivate<Key extends keyof this["_privateSettings"]>(key: Key, callback?: (value: this["_privateSettings"][Key], target?: this, key?: Key) => void): void;
    /**
         * @ignore
         */
     ...
     */
    has<Key extends keyof this["_settings"]>(key: Key): boolean;
    /**
...
export declare class Entity extends Settings implements IDisposer {
    ...
    _setDefaultFn<Key extends keyof this["_settings"], Value extends this["_settings"][Key]>(key: Key, f: () => Value): NonNullable<this["_settings"][Key]> | Value;
