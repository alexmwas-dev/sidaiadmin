...
export declare abstract class Axis<R extends AxisRenderer> extends Component {
     ...
     * @ignore
     */
    abstract getDataItemPositionX(_dataItem: DataItem<IXYSeriesDataItem>, _field: string, _cellLocation?: number, _axisLocation?: number, exactLocation?: boolean): number;
    /**
     * @ignore
     */
    abstract getDataItemPositionY(_dataItem: DataItem<IXYSeriesDataItem>, _field: string, _cellLocation?: number, _axisLocation?: number, exactLocation?: boolean): number;
    /**
     * @ignore
     */
     ...
     * @ignore
     */
    abstract nextPosition(_count?: number): number;
}
